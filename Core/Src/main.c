...
void StartBlinkD3(void * argument);
void StartBlinkD4(void * argument);
void Start7Segment(void * argument);
/************** STUDENT EDITABLE HERE STARTS HERE *****
...
int main(void)
{
   ...
   */
	...
	xTaskCreate(StartBlinkD3,
				"D3_Blink",        /* Text name for the task. */
	            1000,      /* Stack size in words, not bytes. */
	            ( void * ) 1,    /* Parameter passed into the task. */
				tskIDLE_PRIORITY,/* Priority at which the task is created. */
	            &xHandle );

	xTaskCreate(StartBlinkD4,
				"D4_Blink",        /* Text name for the task. */
	            1000,      /* Stack size in words, not bytes. */
	            ( void * ) 1,    /* Parameter passed into the task. */
				tskIDLE_PRIORITY,/* Priority at which the task is created. */
	            &xHandle );

//	xTaskCreate(Start7Segment,
//				"7Segment",        /* Text name for the task. */
//	            1000,      /* Stack size in words, not bytes. */
//	            ( void * ) 1,    /* Parameter passed into the task. */
//				tskIDLE_PRIORITY,/* Priority at which the task is created. */
//	            &xHandle );

	osThreadNew(Start7Segment, "7Segment", &defaultTask_attributes);	// This launches the
////	osThreadNew(StartBlinkD3, "D3 Blink", &defaultTask_attributes);	// This launches the
//	osThreadNew(StartBlinkD4, "D4 Blink", &defaultTask_attributes);	// This launches the
	/*
	 *
     ************** STUDENT EDITABLE HERE STARTS HERE *****
     ************  Task-Creation-Part-C *****************
  ...
  /* add events, ... */
	MultiFunctionShield_Display (0000);  // Lab-04 -- show all 4444's to start
